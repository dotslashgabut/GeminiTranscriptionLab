...
- **Flexible Input**: Upload local audio files or load them directly via URL (CORS permitting).
...
1. **Load Audio**: Use the "Upload" button for local files or paste a direct audio link in the URL box and click "Load".
